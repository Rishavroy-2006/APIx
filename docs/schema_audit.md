# APIx Scraper Schema Audit

This document summarizes the schema audit and schema drift analysis across all scraper scripts in the APIx repository.

---

## 1. Scraper File Inventory & Overview

| Scraper Script | Carrier / Source | Status | Automation Engine | Output Naming Pattern under `apix_data/raw/` |
|---|---|---|---|---|
| [`spicejet/spicejet_scraper.py`](file:///c:/Users/aritr/OneDrive/Desktop/LLM_flights/spicejet/spicejet_scraper.py) | SpiceJet (`SG`) | Present & Tested | `undetected-chromedriver` | `apix_data/raw/<YYYY-MM-DD>/spicejet_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv` |
| [`akasa/akasa_scraper.py`](file:///c:/Users/aritr/OneDrive/Desktop/LLM_flights/akasa/akasa_scraper.py) | Akasa Air (`QP`) | Present & Tested | `undetected-chromedriver` | `apix_data/raw/<YYYY-MM-DD>/akasa_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv` |
| [`indigo/indigo_scraper_uc.py`](file:///c:/Users/aritr/OneDrive/Desktop/LLM_flights/indigo/indigo_scraper_uc.py) | IndiGo (`6E`) | Present & Tested | `undetected-chromedriver` | `apix_data/raw/<YYYY-MM-DD>/indigo_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv` |
| [`air_india/air_india_scraper.py`](file:///c:/Users/aritr/OneDrive/Desktop/LLM_flights/air_india/air_india_scraper.py) | Air India (`AI` / `IX`) | Present & Tested | `seleniumbase` (`SB(uc=True)`) | `apix_data/raw/<YYYY-MM-DD>/air_india_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv` |
...
- **Output naming pattern**: `apix_data/raw/<YYYY-MM-DD>/spicejet_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv`
...
- **Output naming pattern**: `apix_data/raw/<YYYY-MM-DD>/akasa_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv`
...
- **Output naming pattern**: `apix_data/raw/<YYYY-MM-DD>/indigo_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv`
...
- **Python type of `fare_split_estimated`**: `bool` (`False` everywhere; written as `False` in CSV)
- **Casing of `fare_class`**: `"economy"` (lowercase) always
- **Output naming pattern**: `apix_data/raw/<YYYY-MM-DD>/air_india_raw_<YYYY-MM-DD>_batch_<windows>_<HHMM>IST.csv`
