...
const Footer = () => {
  return (
    <footer className="border-t border-border bg-white mt-12 py-6 px-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm font-sans text-textSecondary text-center md:text-left">
      <div className="font-serif font-bold text-navy text-lg leading-none whitespace-nowrap">APIx</div>
      ...
      <div>&copy; 2026 APIx &middot; SIH 26056 Prototype &middot; Submitted to MoSPI</div>
    </footer>
  );
};
